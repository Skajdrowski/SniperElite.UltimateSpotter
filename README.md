...
## Usage
Press INSERT in-game to open up the menu.

First page contains moderation stuff, where you can:

- Kick or Ban players
- Disable TDM Auto Balance

Second page manages player inventories. Currently only custom loadouts are available